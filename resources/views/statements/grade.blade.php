...
<body>
    <div class="container">
        ...
        <div class="info-section">
            ...
            @endif
            <p><strong>Grade:</strong> {{ $reportData['grade']->name }}</p>
        </div>

        <div class="summary-box">
            <div class="summary-title">Grade Payment Summary</div>
        ...
        <div class="fee-details">
            <h3>Student Fee Payment Details</h3>
            @if($studentFees->isEmpty())
                <p>No fee records found for this grade.</p>
            @else
